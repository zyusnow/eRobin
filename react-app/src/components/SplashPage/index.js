    ...
    return (
        <>
            <div className="splash1_container">
                <div className="splash1_sub_container">
                    <div className="splash1_sub_content">
                        ...
                        <div className="splash1_right">
                            <img alt="splash1_image" className="splash1_image" draggable="false" src="https://cdn.robinhood.com/assets/robinhood/brand/_next/static/images/2x__ff9c36e27d7018cf707b95d8675793a3.png"></img>
